...
def encoder(N=8, channel_attention="eca"):
    ...
    x = fl.FusedASPPBlock(filters, channel_attention=channel_attention, name="stage_1_aspp_1")(x)
    ...
    # x = fl.InverseResidualBlock(filters, expand_factor=6, strides=1, channel_attention=channel_attention, name="stage_5_conv_6")(x)
    # x = fl.InverseResidualBlock(filters, expand_factor=6, strides=1, channel_attention=channel_attention, name="stage_5_conv_7")(x)
    # x = fl.InverseResidualBlock(filters, expand_factor=6, strides=1, channel_attention=channel_attention, name="stage_5_conv_8")(x)
